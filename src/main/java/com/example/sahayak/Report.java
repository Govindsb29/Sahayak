...
public class Report extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            out.println("</style>");
            out.println("<head><title>Reported Issues</title></head>");
            out.println("<body>");
            ...
            out.println("<tr style='background-color: #275d7d;'><th style='border: 1px solid white; padding: 8px;'>Issue ID</th><th style='border: 1px solid white; padding: 8px;'>Date</th><th style='border: 1px solid white; padding: 8px;'>Time</th><th style='border: 1px solid white; padding: 8px;'>Reported By</th><th style='border: 1px solid white; padding: 8px;'>Location</th><th style='border: 1px solid white; padding: 8px;'>Landmark</th><th style='border: 1px solid white; padding: 8px;'>Details</th><th style='border: 1px solid white; padding: 8px;'>Image 1</th><th style='border: 1px solid white; padding: 8px;'>Image 2</th><th style='border: 1px solid white; padding: 8px;'>Issue Status</th></tr>");
            ...
            while (rs.next()) {
                ...
                out.println("<td style='border: 1.5px solid white; padding: 8px;'>" + issueStatus + "</td>");
                out.println("</tr>");
            }
