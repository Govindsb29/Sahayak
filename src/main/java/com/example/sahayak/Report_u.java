...
@WebServlet("/Report_u")
public class Report_u extends HttpServlet {
    static Connect cn;
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            String sql = "SELECT * FROM unresolved";
            ResultSet rs = stmt.executeQuery(sql);

            out.println("<html>");
            out.println("<style>");
            out.println("body { background: url('logo.jpeg') center center/cover; background-position: 0% 0%; }");
